...
const createMovie = (movie) => {
	...
	movieElement.querySelector(".signature").textContent = movie.title;
	movieElement.querySelector(".genre").textContent =
		movie.genres.toString();
	movieElement.querySelector(".yeahr").textContent = parseDate(
		movie.release_date
	).year;
